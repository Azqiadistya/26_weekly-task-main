  ...
  lists: [
    ...
    },
    {
      ...
      images: [
        {
          id: 1,
          url: require('@/assets/sections/section4/LandingPage.jpg'),
        },
        {
          id: 2,
          url: require('@/assets/sections/section4/AboutUsPage.jpg'),
        },
        {
          id: 3,
          url: require('@/assets/sections/section4/ServicesPage.jpg'),
        },
      ],
    },
    {
      ...
      images: [
        {
          id: 1,
          url: require('@/assets/sections/section5/tampilanIndex.png'),
        },
        {
          id: 2,
          url: require('@/assets/sections/section5/tampilanForm.png'),
        },
        {
          id: 3,
          url: require('@/assets/sections/section5/tampilanWelcome.png'),
        },
      ],
    },
    {
      ...
      subtitles: [
        ...
        },
        {
          ...
          description: '1. External CSS 2. Internal CSS  3. Inline CSS',
        },
        {
          id: 3,
    ...
    },
    {
      ...
      images: [
        {
          id: 1,
          url: require('@/assets/sections/section7/tampilanDesktop.png'),
        },
        {
          id: 2,
          url: require('@/assets/sections/section7/tampilanMobile.png'),
        },
      ],
    },
    {
      ...
      subtitles: [
        ...
        },
        {
          ...
          description: '1. Var 2. Let 3. Const',
        },
        {
          id: 3,
      ...
      images: [
        {
          id: 1,
          url: require('@/assets/sections/section8/output1.png'),
        },
        {
          id: 2,
          url: require('@/assets/sections/section8/output2.png'),
        },
        {
          id: 3,
          url: require('@/assets/sections/section8/output3.png'),
        },
        {
          id: 4,
          url: require('@/assets/sections/section8/output4.png'),
        },
        {
          id: 5,
          url: require('@/assets/sections/section8/output5.png'),
        },
        {
          id: 6,
          url: require('@/assets/sections/section8/output6.png'),
        },
      ],
    },
    {
      ...
      images: [
        {
          id: 1,
          url: require('@/assets/sections/section9/outputProblem2.png'),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          id: 1,
          url: require('@/assets/sections/section11/doneTodo2.jpg'),
        },
        {
          id: 2,
          url: require('@/assets/sections/section11/sebelumInput.jpg'),
        },
        {
          id: 3,
          url: require('@/assets/sections/section11/setelahInput.jpg'),
        },
        {
          id: 4,
          url: require('@/assets/sections/section11/setelahInput4.jpg'),
        },
      ],
    },
  ],
